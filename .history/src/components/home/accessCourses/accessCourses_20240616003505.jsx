...
function AccessCourses() {
  return (
    <div className="d-flex flex-column bg-f5 flex-xl-row accessGeneral  align-items-center">
        <div className="manPressingLaptop" style={{maxWidth:"611px", position:"relative"}}>
            <div className="imagetext d-none d-lg-block" style={{position:"absolute"}}>
                <div className="d-flex align-items-center opacebackground justify-content-between mb-3" style={{padding:"10px", borderRadius:"20px", maxWidth:"455px"}}>
                    <CustomSvg name="expertLedCourses"/>
                    <div className="d-flex ps-2 justify-content-between align-items-center" style={{width:"340px"}}>
        ...
        <div className=" ms-xl-3"  style={{maxWidth:"576px"}}>
            <p className="txt-f3 fw-500 lh-19 enhance" style={{maxWidth:"370px"}}>2. Enhance Your Skills with Expert-Led Courses</p>
            <p className="fw-500 lh-27 access" style={{maxWidth:"200px"}}>Access Courses</p>
