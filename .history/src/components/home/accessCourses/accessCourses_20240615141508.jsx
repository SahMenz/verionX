  ...
  return (
    <div className="d-flex flex-column bg-f5 flex-lg-row accessGeneral  align-items-center">
        <div className="">
            ...
            <div>
                <div className="bg-d9 d-flex" style={{padding:"5px", borderRadius:"20px", maxWidth:"455px"}}>
                    <CustomSvg name="expertLedCourses"/>
                    <div className="d-flex">
                        <div>
                            <p className="txt-ff fw-500 txt-16 lh-19 pb-2">Satisfaction rate.</p>
                            <p className="txt-11 txt-ff fw-500 lh-13">Courses Highlights</p>
                        </div>
                        <div className="fw-600 txt-19 lh-22">90%</div>
                    </div>
                </div>
                <div className="bg-eb d-flex" style={{padding:"5px", borderRadius:"20px", maxWidth:"390px"}}>
