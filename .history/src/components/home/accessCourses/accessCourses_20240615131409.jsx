...
function AccessCourses() {
  return (
    <div className="d-flex flex-column bg-f5 accessGeneral align-items-center" style={{}}>
        ...
        <div>
            <p className="txt-f3 fw-500 txt-16 lh-19 enhance">2. Enhance Your Skills with Expert-Led Courses</p>
            <p className="fw-500 txt-23 lh-27 py-3 access">Access Courses</p>
            <p className="fw-400 lh-19 txt-16 pb-4 unlock" style={{maxWidth:"576px"}}>
