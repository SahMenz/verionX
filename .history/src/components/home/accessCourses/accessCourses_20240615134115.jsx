...
function AccessCourses() {
  return (
    <div className="d-flex flex-column flex-xl-row justify-content-center justify-content-between align-items-center bg-f5 accessGeneral" style={{maxWidth:"611px"}}>
        <div className=""><img src={accessCoursesImage} alt="a man reading"  className="manPressingLabtop container"/></div>
        <div className="container">
            <p className="txt-f3 fw-500 lh-19 enhance">2. Enhance Your Skills with Expert-Led Courses</p>
            <p className="fw-500 lh-27 access">Access Courses</p>
