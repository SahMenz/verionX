...
function AccessCourses() {
  return (
    <div className="d-flex flex-column bg-f5 accessGeneral align-items-center" style={{maxWidth:"611px"}}>
        <div className="container"><img src={accessCoursesImage} alt="a man reading"  className="manPressingLabtop"/></div>
