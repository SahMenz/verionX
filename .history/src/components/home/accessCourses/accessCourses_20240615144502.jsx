...
function AccessCourses() {
  return (
    <div className="d-flex flex-column bg-f5 flex-lg-row accessGeneral  align-items-center">
        <div className="">
            <img src={accessCoursesImage} alt="a man reading"  className="manPressingLabtop container" style={{maxWidth:"611px", position:"relative", zIndex:"0"}}/>
            <div className="d-none d-xl-block" style={{position:"absolute", top:"50%", left:"30%", zIndex:"1"}}>
