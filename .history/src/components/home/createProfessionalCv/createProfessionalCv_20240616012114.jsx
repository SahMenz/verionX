  ...
  return (
    <div className='d-flex flex-column bg-f5 flex-xl-row align-items-center'>
        <div>
            ...
            <div className='fw-400 txt-16 lh-19' style={{margin:"0px 10px 29px 0px"}}><CustomSvg name="createProfessionalTick"/> Highlight your skills, experiences, and achievements</div>
