  ...
  return (
    <div className='d-flex flex-column bg-f5 flex-xl-row align-items-center'>
        <div>
            ...
            <div className='fw-400 txt-16 lh-19' style={{marginBottom:"29px"}}><CustomSvg name="createProfessionalTick"/> <span style={{marginRight:"100px"}}>Professional, customizable templates</span></div>
            <div className='fw-400 txt-16 lh-19' style={{marginBottom:"29px"}}><CustomSvg name="createProfessionalTick"/> <span style={{marginRight:"10px"}}>Easy-to-use tools for a polished, professional look</span></div>
            <div className='fw-400 txt-16 lh-19' style={{marginBottom:"29px"}}><CustomSvg name="createProfessionalTick"/> <span style={{marginRight:"10px"}}>Highlight your skills, experiences, and achievements</span></div>
