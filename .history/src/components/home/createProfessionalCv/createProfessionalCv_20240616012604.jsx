  ...
  return (
    <div className='d-flex flex-column bg-f5 flex-xl-row align-items-center'>
        <div>
            ...
            <div className='fw-400 txt-16 lh-19' style={{marginBottom:"29px"}}><CustomSvg name="createProfessionalTick"/> <span style={{marginLeft:"100px"}}>Professional, customizable templates</span></div>
