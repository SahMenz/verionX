...
function Companies() {
  return (
    <div className='d-flex justify-content-center flex-column align-items-center'>
        <div>
            <div className='d-flex flex-column align-content-between' style={{maxWidth:"320px"}}>
                <div className='fw-500 txt-16 lh-19 mb-3 txt-f3'>1. Discover Your Next Opportunity</div>
                <div className='fw-500 txt-23 lh-27' style={{maxWidth:"161px"}}>Get Job Offers</div>
            </div>
            <div></div>
        </div>
