  ...
  return (
    <div className='companyGeneral d-flex justify-content-center flex-column align-items-center'>
        <div className=''>
            ...
            <div>
                <div className='fw-400 txt-16 lh-19 p-2' style={{maxWidth:"513px"}}>Elevate your career with Verion X. Connect with leading employers and curated opportunities tailored to you.</div>
