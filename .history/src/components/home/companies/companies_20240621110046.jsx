...
function Companies() {
  return (
    <div className='companyGeneral d-flex justify-content-center flex-column align-items-center'>
        ...
        <button className='d-flex bg-ff flex-column align-items-center justify-content-center' style={{maxWidth:"85",border:"1px solid black",borderRadius:"30px", padding:"9px 31px"}}><div className='fw-500 txt-16 lh-19'>show more</div><div><CustomSvg name="dropDownArrow"/></div></button>
    </div>
  )
}
