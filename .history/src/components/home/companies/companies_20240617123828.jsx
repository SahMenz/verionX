...
function Companies() {
  return (
    <div>
        ...
        <button className='d-flex bg-ff align-items-center justify-content-center' style={{maxWidth:"85",borderRadius:"30px", padding:"11px 31px"}}><div className='fw-500 txt-16 lh-19'>show more</div><div><CustomSvg name="dropDownArrow"/></div></button>
    </div>
  )
}
