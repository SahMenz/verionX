    ...
    <div className='companyGeneral d-flex justify-content-center flex-column align-items-center'>
        ...
        <div className='d-flex flex-wrap justify-content-center p-3 p-xl-2' style={{maxWidth:"1390px", gap:"20px", marginBottom:"40px"}}>
            {getJobOffers.map((getJobs) => (
                <>
                <div className='companyJobs' style={{maxWidth:"295px", borderRadius:"10px", boxShadow:"0px 0px 3px 3px rgba(211, 211, 211, 0.5)",padding:"24px"}}>
        ...
        <button className='d-flex bg-ff flex-column align-items-center justify-content-center' style={{maxWidth:"85",border:"1px solid black",borderRadius:"30px", padding:"5px 29px"}}><div className='fw-500 txt-16 lh-19'>show more</div><div><CustomSvg name="dropDownArrow"/></div></button>
    </div>
  )
}
