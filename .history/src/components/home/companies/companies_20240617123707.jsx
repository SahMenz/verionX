...
function Companies() {
  return (
    <div>
        ...
        <button className='d-flex bg-ff align-items-center justify-content-center' style={{borderRadius:"30px"}}><div>show more</div><div><CustomSvg name="dropDownArrow"/></div></button>
    </div>
  )
}
