    ...
    <div className='bg-f5 heroGeneral' style={{}}>
        <div style={{}} className=' textcontainer d-flex flex-column container'>
            ...
            <div className="container ">
                <input type="text" className='p- col-10' placeholder="Search for any service..."  style={{width:"55vw",maxWidth:"733px",position:'absolute',borderRadius:"10px", boxShadow: "0px 0px 3px 3px rgba(0, 0, 0, 0.2)"}} />
