    ...
    <div className='d-flex align-items-center justify-content-between py-4 bg-f5' style={{padding: "0px 100px",}}>
        <div style={{width: "50vw", maxWidth:"800px"}}>
            ...
            <div className="search-container">
                ...
                <button className="bg-eb p-3" style={{borderRadius:"10px", border:"none", position: "relative", left: "0px", transform: "translateX(1170%)",}}><CustomSvg name="search" style={{borderRadius:"10px"}}/></button>
            </div>
            <div></div>
        </div>
