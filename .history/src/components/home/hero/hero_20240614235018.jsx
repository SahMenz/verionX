...
function Hero() {
  return (
    <div className='bg-f5 heroGeneral' style={{}}>
        <div style={{width: "50vw", maxWidth:"800px"}} className=' textcontainer d-flex flex-column'>
            ...
            <div className='txt-00 lh-26 txt-19 exploretxt' style={{}}>
            ...
            <div className="search-container mb-5 d-none">
                ...
                <button className="bg-eb" style={{position:'relative', left:"700px", borderRadius:"10px", border:"none", }}><CustomSvg name="search"/></button>
            </div>
