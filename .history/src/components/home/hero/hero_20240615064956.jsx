    ...
    <div className='bg-f5 heroGeneral .container d-flex flex-column justify-content-center align-items-center' style={{}}>
        <div style={{}} className=' textcontainer mb-5 d-flex flex-column container'>
            ...
            <div className="d-flex justify-content-between">
                <input type="text" className='p-3' placeholder="Search for any service..."  style={{borderRadius:"10px", boxShadow: "0px 0px 3px 3px rgba(0, 0, 0, 0.2)"}} />
        ...
        <img src={accesYourPerfectImage} style={{width: "40vw", maxWidth:"437px"}} alt="three images" />
    </div>
  )
}
