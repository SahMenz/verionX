    ...
    <div className='bg-f5 heroGeneral d-flex flex-column flex-xl-row justify-content-center justify-content-between align-items-center' style={{}}>
        <div style={{maxWidth:"733px"}} className=' textcontainer mb-5 mx-xxl-1 px-xxl-0 d-flex flex-column container '>
            ...
            <div className="d-flex">
                <input type="text" className='p-3 container mb-xxl-5' placeholder="Search for any service..."  style={{borderRadius:"10px", boxShadow: "0px 0px 3px 3px rgba(0, 0, 0, 0.2)"}} />
                <button className="bg-eb p-3" style={{borderRadius:"10px", border:"none"}}><CustomSvg name="search"/></button>
            </div>
            <div className='d-none d-xl-flex align-items-center justify-content-center'style={{width:"642px"}} >
        ...
        <img src={accesYourPerfectImage} className='container mx-xxl-1 px-xxl-0' style={{maxWidth:"35vw"}} alt="three images" />
    </div>
  )
}
