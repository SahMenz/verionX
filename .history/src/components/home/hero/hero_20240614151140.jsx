    ...
    <div className='d-flex align-items-center justify-content-between py-4 bg-f5' style={{padding: "0px 100px",}}>
        <div style={{width: "50vw", maxWidth:"800px"}}>
            ...
            <div className="search-container">
                ...
                <button className="bg-eb p-3" style={{borderRadius:"10px", border:"none", position: "relative", left: "110px", transform: "rotateY('-50%')",}}><CustomSvg name="search" style={{borderRadius:"10px"}}/></button>
            </div>
            <div></div>
        </div>
