...
function Hero() {
  return (
    <div className='bg-f5 heroGeneral d-flex flex-column flex-xl-row justify-content-center justify-content-between align-items-center' style={{}}>
        <div style={{maxWidth:"733px"}} className=' textcontainer mb-5 mx-xxl-0 px-xxl-0 d-flex flex-column container '>
            ...
            <div className='txt-00 lh-26 mb-4 exploretxt' style={{maxWidth:"630"}}>
        ...
        <img src={accesYourPerfectImage} className='container mx-xxl-0 px-xxl-0' style={{maxWidth:"35vw"}} alt="three images" />
    </div>
  )
}
