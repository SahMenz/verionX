...
function Hero() {
  return (
    <div className='bg-f5 heroGeneral d-flex flex-column flex-xl-row justify-content-center justify-content-between-xxl align-items-center' style={{}}>
        <div style={{maxWidth:"733px"}} className=' textcontainer mb-5 d-flex flex-column container '>
            ...
            <div className='txt-00 lh-26 mb-4 exploretxt' style={{}}>
            ...
            <div className="d-flex">
                <input type="text" className='p-3 container' placeholder="Search for any service..."  style={{borderRadius:"10px", boxShadow: "0px 0px 3px 3px rgba(0, 0, 0, 0.2)"}} />
                <button className="bg-eb p-3" style={{borderRadius:"10px", border:"none"}}><CustomSvg name="search"/></button>
            </div>
        ...
        <img src={accesYourPerfectImage} className='container' style={{maxWidth:"35vw"}} alt="three images" />
    </div>
  )
}
