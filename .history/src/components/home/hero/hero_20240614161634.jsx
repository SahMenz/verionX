    ...
    <div className='d-flex align-items-center justify-content-between flex-column flex-xl-row  py-4 bg-f5' style={{padding: "0px 100px",}}>
        <div style={{width: "50vw", maxWidth:"800px"}} className='me-lg-5'>
            ...
            <div className="search-container mb-5">
                <input type="text" placeholder="Search for any service..."  style={{width:"55vw",maxWidth:"733px",position:'absolute',borderRadius:"10px", boxShadow: "0px 0px 3px 3px rgba(0, 0, 0, 0.2)"}} className='p-3 me-3'/>
                <button className="bg-eb p-3" style={{position:'relative', left:"0px", borderRadius:"10px", border:"none", }}><CustomSvg name="search"/></button>
            </div>
            <div className='d-none align-items-center justify-content-between d-md-flex'style={{width:"642px"}} >
