  ...
  return (
    <div className='d-flex align-items-center justify-content-between flex-column flex-xl-row  py-4 bg-f5' style={{padding: "0px 100px",}}>
        <div style={{width: "50vw", maxWidth:"800px"}} className='me-lg-5'>
            ...
            <div className='d-none align-items-center justify-content-between d-md-flex'style={{width:"45vw",maxWidth:"642px"}} >
                <div className='txt-19 lh-26 txt-500'>Top Search:</div>
                <div className='d-flex align-items-center justify-content-between g-5' style={{width:"507px"}}>
