...
function Hero() {
  return (
    <div className='d-flex align-items-center justify-content-between py-4 bg-f5' style={{padding: "0px 100px", zIndex: "1" ,boxShadow: "0px 10px 10px 10px rgba(0, 0, 0, 0.2)"}}>
