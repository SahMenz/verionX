...
function Hero() {
  return (
    <div className='  py-4 bg-f5 heroGeneral d-flex align-items-center flex-column' style={{}}>
        <div style={{width: "50vw", maxWidth:"800px"}} className='me-lg-5 textcontainer d-flex flex-column'>
            <div className='txt-63 lh-75 txt-ff fw-600 txt-00 largeTxt' style={{}}>Access Your Perfect Career With <span className='bg-eb fw-600 txt-ff py-1 px-3'>VERION X</span></div>
