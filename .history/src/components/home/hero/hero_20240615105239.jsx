...
function Hero() {
  return (
    <div className='bg-f5 heroGeneral d-flex flex-column flex-xl-row px-lg-3 justify-content-center align-items-center' style={{}}>
        ...
        <img src={accesYourPerfectImage} className='container' style={{}} alt="three images" />
    </div>
  )
}
