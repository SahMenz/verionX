  ...
  return (
    <div className='d-flex align-items-center justify-content-between py-4 bg-f5' style={{padding: "0px 100px",}}>
        <div style={{width: "50vw", maxWidth:"800px"}}>
            <div className='txt-63 lh-75 txt-ff fw-600 txt-00' style={{width: "50vw", maxWidth:"733px"}}>Access Your Perfect Career With <span className='bg-eb fw-600 txt-ff' style={{padding:"10px"}}>VERION X</span></div>
