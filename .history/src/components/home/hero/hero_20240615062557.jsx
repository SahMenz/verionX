  ...
  return (
    <div className='bg-f5 heroGeneral' style={{}}>
        <div style={{}} className=' textcontainer d-flex flex-column container'>
            <div className='txt-63 lh-75 txt-ff fw-600 txt-00 largeTxt m    b-5' style={{}}>Access Your Perfect Career With <span className='bg-eb fw-600 txt-ff py-1 px-3'>VERION X</span></div>
            <div className='txt-00 lh-26 txt-19 mb-3 exploretxt' style={{}}>
