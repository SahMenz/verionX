  ...
  return (
    <div className='bg-f5 heroGeneral' style={{}}>
        <div style={{}} className=' textcontainer d-flex flex-column container'>
            <div className='txt-63 lh-75 txt-ff fw-600 txt-00 largeTxt pb-5' style={{}}>Access Your Perfect Career With <span className='bg-eb fw-600 txt-ff py-1 px-3'>VERION X</span></div>
