    ...
    <div className='d-flex align-items-center justify-content-between py-4 bg-f5' style={{padding: "0px 100px",}}>
        <div style={{width: "50vw", maxWidth:"800px"}}>
            ...
            <div className="search-container d-flex">
                <input type="text" placeholder="Search for any service..."  style={{position:'relative',borderRadius:"10px", boxShadow: "0px 0px 3px 3px rgba(0, 0, 0, 0.2)"}} className='p-3'/>
                <button className="bg-eb p-3" style={{position:'absolute', right:"0px", borderRadius:"10px", border:"none", }}><CustomSvg name="search"/></button>
            </div>
            <div></div>
        </div>
