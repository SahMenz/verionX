...
function Hero() {
  return (
    <div className='bg-f5 heroGeneral d-flex flex-column justify-content-center align-items-center' style={{}}>
        <div style={{}} className=' textcontainer mb-5 d-flex flex-column container-lg '>
