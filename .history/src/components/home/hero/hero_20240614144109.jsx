    ...
    <div className='d-flex align-items-center justify-content-between py-4 bg-f5' style={{padding: "0px 100px",}}>
        <div style={{width: "50vw", maxWidth:"733px"}}>
            ...
            <div className="search-container">
                ...
                <button><CustomSvg name="search"/></button>
            </div>
            <div></div>
        </div>
...
.search-button {
    position: absolute; /* Make button sit inside input */
    right: 5px; /* Adjust positioning as needed */
    top: 50%; /* Center button vertically */
    transform: translateY(-50%); /* Offset vertical positioning */
    /* Other button styles from previous example */
  }