    ...
    <div className='d-flex align-items-center justify-content-between py-4 bg-f5' style={{padding: "0px 100px",}}>
        <div style={{width: "50vw", maxWidth:"800px"}}>
            ...
            <div className='d-flex' >
                ...
                <div className='d-flex'>
                    <button style={{borderRadius:"20px",border: "2px solid black", padding:"20px"}}><div className='txt-19 lh-22 txt-500'>UX Design</div></button>
                    <button style={{borderRadius:"20px",border: "2px solid black", padding:"20px"}}><div className='txt-19 lh-22 txt-500'>Web Design</div></button>
                    <button style={{borderRadius:"20px",border: "2px solid black", padding:"20px"}}><div className='txt-19 lh-22 txt-500'>Technical writing</div></button>
                </div>
            </div>
        </div>
