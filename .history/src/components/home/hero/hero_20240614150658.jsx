    ...
    <div className='d-flex align-items-center justify-content-between py-4 bg-f5' style={{padding: "0px 100px",}}>
        <div style={{width: "50vw", maxWidth:"800px"}}>
            ...
            <div className="search-container">
                ...
                <button className="bg-eb p-3" style={{borderRadius:"10px", border:"none"}}><CustomSvg name="search" style={{borderRadius:"10px" ,position: "absolute", right: "0px", top:"50%", transform: "translateY(-50%)"}}/></button>
            </div>
            <div></div>
        </div>
