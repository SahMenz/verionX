...
function Hero() {
    ...
    function handleSubscribe(event){
        ...
        console.log(post)
        // axios.post("https://verionx-api.onrender.com/api/v1/users/register-mail-to-mail-list", {
        //     headers: {
  ...
  return (
    <div className='bg-f5 heroGeneral d-flex flex-column flex-xl-row justify-content-center justify-content-between align-items-center'>
        <div style={{maxWidth:"733px"}} className=' textcontainer mb-5 mx-xxl-1 px-xxl-0 d-flex flex-column container '>
            ...
            <form className="d-flex" onSubmit={handleSubscribe}>
                <input type="text" onChange={handleInput} name='subscribe' className=' container p-3 mb-xl-5 inputText' placeholder="Search for any service..."  style={{boxShadow: "-1px 0px 5px 0px rgba(0, 0, 0, 0.2)"}} />
                <button className="bg-eb p-3 mb-xl-5 inputButton" style={{boxShadow: "0px -1px 5px 0px rgba(0, 0, 0, 0.2)"}}><CustomSvg name="search"/></button>
            </form>
