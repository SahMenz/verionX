...
function Hero() {
  return (
    <div className='d-flex align-items-center justify-content-between py-4 bg-f5' style={{padding: "0px 100px",}}>
        <div style={{width: "50vw", maxWidth:"773px"}}>
            ...
            <div className="search-container" >
                ...
                <button className="bg-eb p-2"><CustomSvg name="search" style={{borderRadius:"10px" ,position: "absolute", right: "5px", top:"50%", transform: "translateY(-50%)"}}/></button>
            </div>
            <div></div>
        </div>
