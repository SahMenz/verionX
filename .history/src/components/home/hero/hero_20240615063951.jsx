...
function Hero() {
  return (
    <div className='bg-f5 heroGeneral .container d-flex flex-column justify-content-center align-items-center' style={{}}>
        <div style={{}} className=' textcontainer mb-5 d-flex flex-column container'>
            ...
            <div className="container d-flex justify-conten">
                <input type="text" className='p-3 col-10' placeholder="Search for any service..."  style={{width:"55vw",maxWidth:"733px",borderRadius:"10px", boxShadow: "0px 0px 3px 3px rgba(0, 0, 0, 0.2)"}} />
                <button className="bg-eb p-3 col-3" style={{borderRadius:"10px", border:"none", }}><CustomSvg name="search"/></button>
            </div>
