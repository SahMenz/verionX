  ...
  return (
    <div className='d-flex align-items-center justify-content-between flex-column flex-xl-row  py-4 bg-f5' style={{padding: "0px 100px",}}>
        <div style={{width: "50vw", maxWidth:"800px"}} className='me-lg-5'>
            ...
            <div className="search-container mb-5 d-flex">
                ...
                <button className="bg-eb p-3 align-self-end" style={{position:'relative', left:"0px", borderRadius:"10px", border:"none", }}><CustomSvg name="search"/></button>
            </div>
