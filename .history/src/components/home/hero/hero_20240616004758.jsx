...
function Hero() {
  return (
    <div className='bg-f5 heroGeneral d-flex flex-column flex-xl-row justify-content-center justify-content-between align-items-center' style={{}}>
        <div style={{maxWidth:"733px"}} className=' textcontainer mb-5 mx-xxl-1 px-xxl-0 ms-xl-3 d-flex flex-column container '>
        ...
        <img src={accesYourPerfectImage} className='container mx-xxl-1 px-xxl-0' style={{maxWidth:"65vw"}} alt="three images" />
    </div>
  )
}
