  ...
  return (
    <div className='bg-f5 heroGeneral d-flex flex-column flex-xl-row justify-content-center justify-content-between align-items-center' style={{}}>
        <div style={{maxWidth:"733px"}} className=' textcontainer mb-5 mx-xxl-1 px-xxl-0 d-flex flex-column container '>
            ...
            <form className="d-flex" onSubmit={handleSubscribe} style={{maxWidth:"733px"}}>
                <input type="text" onChange={handleInput} name='subscribe' className='p-3 mb-xl-5 inputText' placeholder="Search for any service..."  style={{position:"relative",borderRadius:"10px", boxShadow: "0px 0px 3px 3px rgba(0, 0, 0, 0.2)"}} />
                <button className="bg-eb p-3 mb-xl-5 inputButton"><CustomSvg name="search"/></button>
            </form>
