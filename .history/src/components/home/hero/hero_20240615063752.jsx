    ...
    <div className='bg-f5 heroGeneral .container d-flex flex-column justify-content-center align-items-center' style={{}}>
        <div style={{}} className=' textcontainer d-flex flex-column container'>
            ...
            <div className="container d-flex justify-content-between">
                <input type="text" className='p-3 mb-4 col-10' placeholder="Search for any service..."  style={{width:"55vw",maxWidth:"733px",position:'absolute',borderRadius:"10px", boxShadow: "0px 0px 3px 3px rgba(0, 0, 0, 0.2)"}} />
