    ...
    <div className='d-flex align-items-center justify-content-between py-4 bg-f5' style={{padding: "0px 100px",}}>
        <div style={{width: "50vw", maxWidth:"800px"}}>
            ...
            <div className="search-container">
                <input type="text" placeholder="Search for any service..."  style={{position: "absolute",width: "733px", borderRadius:"10px", boxShadow: "0px 0px 3px 3px rgba(0, 0, 0, 0.2)"}} className='p-3'/>
                <button className="bg-eb p-3" style={{borderRadius:"10px", border:"none", position: "relative", right: "0px", top:"50%", transform: "translateY(-50%)"}}><CustomSvg name="search" style={{borderRadius:"10px"}}/></button>
            </div>
            <div></div>
        </div>
