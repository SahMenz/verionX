...
function Hero() {
  return (
    <div className='d-flex align-items-center justify-content-between flex-direction-lg-column py-4 bg-f5' style={{padding: "0px 100px",}}>
        <div style={{width: "50vw", maxWidth:"800px"}} className='me-lg-5'>
            ...
            <div className='d-flex align-items-center justify-content-between'style={{width:"642px"}} >
