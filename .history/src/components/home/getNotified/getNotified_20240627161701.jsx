  ...
  return (
    <div className='d-flex align-items-center flex-column getContainer'>
        ...
        <div>
            ...
            <div onClick={() => setOpen(!open)} aria-controls="example-collapse-text" aria-expanded={open}  className='d-flex flex-wrap flex-column gap-3  gap-xl-4 px-xl-2 justify-content-center' style={{maxWidth:"1390px"}}>
                <Accordion 
                    title="What is verion X"   
                    accordionDescription="Verion X is a comprehensive career development platform designed to help you achieve your professional goals. We connect job seekers with top employers, offer a wide range of skill-enhancing courses, and provide professional CV templates to help you stand out in the job market." 
                />
            </div>
        </div>
    </div>
