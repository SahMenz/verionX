  ...
  return (
    <div className='d-flex align-items-center flex-column getContainer'>
        <div className="bg-eb d-flex flex-column justify-content-between getGeneral text-center">
            ...
            <form action="" className=' mt-lg-5 mt-4 getSubscriber'>
        ...
        <div>
            ...
            <div  className='d-flex flex-wrap gap-3  gap-xl-4 px-xl-2 justify-content-center' style={{maxWidth:"1390px", marginBottom:open || open1 || open2 || open3 || open4 || open5 ? "130px" : ""}}>
                <div className='d-flex flex-wrap gap-3  gap-xl-4 px-xl-2 justify-content-center' style={{width:"90vw", maxWidth:"663px", maxHeight:"263px", marginBottom: open2 ? "130px" : ""}}>
                ...
                <div className='d-flex flex-wrap gap-3 gap-xl-4 px-xl-2 justify-content-center' style={{width:"90vw", maxWidth:"663px", maxHeight:"263px", marginBottom: open5 ? "130px" : ""}}>
