    ...
    <div className='d-flex align-items-center flex-column getContainer'>
        ...
        <div>
            ...
            <div className='d-flex flex-wrap gap-3  gap-xl-4 justify-content-center' style={{maxWidth:"1390px"}}>
                <button className='bg-ec d-flex align-items-center justify-content-between' style={{borderRadius:"20px", padding:"", width:"90vw", maxWidth:"663px"}}><div className='fw-400 textAdjust text-start lh-34' style={{width:"70vw"}}>What is Verion X?</div> <div><CustomSvg name="plus" /></div></button>
