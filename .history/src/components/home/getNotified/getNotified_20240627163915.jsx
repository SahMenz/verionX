  ...
  return (
    <div className='d-flex align-items-center flex-column getContainer'>
        ...
        <div>
            ...
            <div>fjfnjnjn
        <div onClick={() => setOpen(!open)} className="d-none bg-ec flex-column align-items-center justify-content-between " style={{borderRadius:"20px",width:"90vw", maxWidth:"663px"}}>
            <div className='d-flex align-items-center justify-content-between' style={{padding:"20px 29px 20px 18px", width:"90vw", maxWidth:"663px"}}>
                <div className='fw-400 textAdjust text-start lh-34' style={{width:"70vw"}}>nsnjn</div>
                <div><CustomSvg name="minus" /></div>
            </div>
            <Fade  in={open} aria-controls="example-collapse-text" aria-expanded={open}>
