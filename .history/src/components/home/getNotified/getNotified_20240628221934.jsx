    ...
    <div className='d-flex align-items-center flex-column getContainer'>
        <div className="bg-eb d-flex flex-column justify-content-between getGeneral text-center">
            ...
            <div action="" className='d-flex bg-ff mt-lg-5 mt-4 getSubscriber' style={{borderRadius:"30px",padding:"9px 9px 9px 30px"}}>
              <input type="text" placeholder="Your email address" className='inputText' style={{width:"90vw", maxWidth:"455px", }}/>
              <button className='bg-eb txt-ff d-none lh-22 fw-400 txt-19 getSubscriberButton' style={{padding:"12px 40px", borderRadius:"20px"}}>Get Update</button>
              <CustomSvg className="d-block" name="telegram"/>
            </div>
        </div>
