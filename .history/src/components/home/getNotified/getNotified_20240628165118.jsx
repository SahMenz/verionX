  ...
  return (
    <div className='d-flex align-items-center flex-column getContainer'>
        ...
        <div>
            ...
            <div className='d-flex flex-wrap gap-3  gap-xl-4 px-xl-2 justify-content-center' style={{width:"90vw", maxWidth:"663px"}}>
            ...
            <div className='d-flex flex-wrap gap-3 bg-primary  gap-xl-4 px-xl-2 justify-content-center' style={{width:"90vw", maxWidth:"663px", maxHeight:"300px"}}>
