  ...
  return (
    <div className='d-flex align-items-center flex-column getContainer'>
        ...
        <div>
            ...
            <div>
                <button className='bg-ec d-flex' style={{borderRadius:"30px", padding:"18px 0px 29px 18px"}}><div className='fw-400 txt-23 lh-34'>What is Verion X?</div> <div><CustomSvg name="plus" /></div></button>
            </div>
        </div>
    </div>
  )
