  ...
  return (
    <div className='d-flex align-items-center flex-column getContainer'>
        <div className="bg-eb d-flex flex-column justify-content-between getGeneral text-center">
            ...
            <form action="" className='bg-ff mt-lg-5 mt-4 getSubscriber p-2'>
              <input type="text" placeholder="Your email address" className='inputText' style={{borderRadius:"30px", padding:"20px 0px 20px 30px"}}/>
