    ...
    <div className='d-flex align-items-center flex-column getContainer'>
        ...
        <div>
            ...
            <div className='d-flex flex-wrap gap-3  gap-xl-4 justify-content-center' style={{maxWidth:"1390px"}}>
              {
                accordionOpen ? 
                <button className='bg-ec flex-column flex-start  d-flex align-items-center justify-content-between' onClick={toggleAccordion} style={{borderRadius:"20px",width:"90vw", maxWidth:"663px"}}>
