    ...
    <div className='d-flex align-items-center flex-column getContainer'>
        ...
        <div>
            ...
            <div className='d-flex flex-wrap'>
                ...
                <button className='bg-ec d-flex' style={{borderRadius:"20px", padding:"18px 2px 29px 18px"}}><div className='fw-400 textAdjust lh-34'>How do I create a profile on Verion X?</div> <div><CustomSvg name="plus" /></div></button>
