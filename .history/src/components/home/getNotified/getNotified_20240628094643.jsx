    ...
    <div className='d-flex align-items-center flex-column getContainer'>
        ...
        <div>
            ...
            <div  className='d-flex flex-wrap gap-3  gap-xl-4 px-xl-2 justify-content-center' style={{maxWidth:"1390px"}}>
                <div className='bg-ec flex-column d-flex align-items-center justify-content-between' style={{borderRadius:"20px",width:"90vw", maxWidth:"663px"}}>
                    <div onClick={() => setOpen(!open)} aria-controls="example-fade-text" aria-expanded={open}>
                        <div className='d-flex align-items-center justify-content-between' style={{padding:"20px 29px 20px 18px", height: open ? "70px" : "70px", width:"90vw", maxWidth:"663px"}}>
                ...
                <div>
                    <div onClick={() => setOpen1(!open1)} aria-controls="example-fade-text" aria-expanded={open}>
