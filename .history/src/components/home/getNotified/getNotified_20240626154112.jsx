...
function GetNotified() {
  const  [accordionOpen, setAccordoinOpen] = useState(false);

  const toggleAccordion = () => {
    setAccordoinOpen(!accordionOpen);
  };
    ...
    <div className='d-flex align-items-center flex-column getContainer'>
        ...
        <div>
            ...
            <div className='d-flex flex-wrap gap-3  gap-xl-4 justify-content-center' style={{maxWidth:"1390px"}}>
              {
                accordionOpen ? 
                <button className='bg-ec flex-column d-flex align-items-center justify-content-between' onClick={toggleAccordion} style={{borderRadius:"20px",width:"90vw", maxWidth:"663px"}}>
                  ...
                  <div className='fw-400 txt-16 lh-26 justify-content-start d-flex' style={{borderRadius:"20px", padding:"20px 29px 20px 18px", width:"90vw", maxWidth:"663px"}}>
                ...
                <button className='bg-ec d-flex align-items-center justify-content-between' onClick={toggleAccordion} style={{borderRadius:"20px",width:"90vw", maxWidth:"663px"}}>
                  <div className='d-flex align-items-center justify-content-between' style={{padding:"20px 29px 20px 18px", width:"90vw", maxWidth:"663px"}}>
                      <div className='fw-400 textAdjust text-start lh-34' style={{width:"70vw"}}>What is Verion X?</div>
                      <div><CustomSvg name="plus" /></div>
                  </div>
