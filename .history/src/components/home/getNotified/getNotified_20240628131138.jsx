  ...
  return (
    <div className='d-flex align-items-center flex-column getContainer'>
        <div className="bg-eb d-flex flex-column justify-content-between getGeneral text-center">
            ...
            <form action="" className=' mt-lg-5 mt-4 inputText bg-primary getSubscriber'>
              <input type="text" placeholder="Your email address" className='' style={{borderRadius:"30px", padding:"20px 0px 20px 30px", maxWidth:"652px"}}/>
