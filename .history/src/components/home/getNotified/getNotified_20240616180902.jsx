    ...
    <div className='d-flex align-items-center flex-column getContainer'>
        ...
        <div>
            ...
            <div className='d-flex flex-wrap'>
                <button className='bg-ec d-flex' style={{borderRadius:"20px", padding:"18px 0px 29px 18px"}}><div className='fw-400 textAdjust lh-34'>What is Verion X?</div> <div><CustomSvg name="plus" /></div></button>
