        ...
        <div className='d-flex mb-5 align-items-center flex-column getContainer'>
            ...
            <div>
                ...
                <div  className='d-flex flex-wrap gap-xl-4 px-xl-2 justify-content-center' style={{maxWidth:"1390px", gap:"30px"}}>
                    ...
                    {/* <div className='d-flex flex-wrap gap-2 gap-xl-3 px-xl-2 justify-content-center' style={{width:"90vw", maxWidth:"663px", maxHeight:"263px", marginBottom: open3 || open4 || open5 ? "130px" : "", marginTop:open || open1 || open2 ? "120px" : ""}}> */}
                    <div className='d-flex flex-wrap gap-2 gap-xl-3 px-xl-2 justify-content-center' style={{width:"90vw", maxWidth:"663px", maxHeight:"263px", marginBottom: open3 || open4 || open5 ? "130px" : "", marginTop:open || open1 || open2 ? "85px" : ""}}>
