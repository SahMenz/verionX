  ...
  return (
    <div className='d-flex align-items-center flex-column getContainer'>
        ...
        <div>
            ...
            <div>fjfnjnjn
        <div aria-controls="example-collapse-text" aria-expanded={open} onClick={() => setOpen(!open)} className="d-none bg-ec flex-column align-items-center justify-content-between " style={{borderRadius:"20px",width:"90vw", maxWidth:"663px"}}>
