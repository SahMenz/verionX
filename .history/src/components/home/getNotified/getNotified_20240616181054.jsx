    ...
    <div className='d-flex align-items-center flex-column getContainer'>
        ...
        <div>
            ...
            <div className='d-flex flex-wrap'>
                <button className='bg-ec d-flex justify-content-between' style={{borderRadius:"20px", padding:"18px 29px 29px 18px", width:"80vw"}}><div className='fw-400 textAdjust lh-34'>What is Verion X?</div> <div><CustomSvg name="plus" /></div></button>
