...
function Navigation() {
  ...
  return (
    <div className="d-flex justify-content-between navContainer">
        <img src={logo} alt="" />
        <div className='d-none navigationLink justify-content-between align-items-center'>
        ...
        <div className=' d-lg-none' style={{width: "40px", height: "40px", display: 'flex', flexDirection: 'column', alignItems: "center", justifyContent: "center", gap: "5px"}}>
