      ...
      <Offcanvas show={show} onHide={handleClose} placement="end" className='' style={{backgroundColor:"#737373"}}>
          ...
          <div className='d-flex flex-column d-lg-flex justify-content-center align-items-center'>
            <div className='d-flex flex-column mb-4 justify-content-between align-items-center' style={{height:"200px"}}>
              <a href="#" className='small-txt lh-19 fw-600 text-decoration-none txt-ff'>Home</a>
              <a href="#" className='small-txt lh-19 fw-600 text-decoration-none txt-ff'>Find job</a>
              <a href="#" className='small-txt lh-19 fw-600 text-decoration-none txt-ff'>Courses</a>
              <a href="#" className='small-txt lh-19 fw-600 text-decoration-none txt-ff'>Cvs</a>
            </div>
            <div className='d-flex flex-column justify-content-between align-items-center' style={{height:"150px"}}>
              <a href="#" className='small-txt lh-19 fw-600 text-decoration-none txt-ff'>Sign up</a>
              <a href="#" className='small-txt lh-19 fw-600 text-decoration-none txt-ff bg-eb px-4 py-2 rounded-5'>Login</a>
              <button className='bg-ff'><CustomSvg name="switchModes"/></button>
            </div>
          </div>
