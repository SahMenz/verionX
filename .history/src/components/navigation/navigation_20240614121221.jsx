...
function Navigation() {
  ...
  return (
    <div className="d-flex justify-content-between navContainer">
        ...
        <div style={{width: "40px", height: "40px", display: 'flex', flexDirection: 'column', backgroundColor: "#000", alignItems: "center", justifyContent: "center"}}>
          <div style={{width : "30px", height:"3px", backgroundColor : '#130828' }}></div>
          <div style={{width : "30px", height:"3px", backgroundColor : '#130828' }}></div>
          <div style={{width : "30px", height:"3px", backgroundColor : '#130828' }}></div>
        </div>
    </div>
