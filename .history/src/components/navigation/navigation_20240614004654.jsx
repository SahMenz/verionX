...
function Navigation() {
  return (
    <div className="d-flex justify-content-between navContainer">
        <img src={logo} alt="" />
        <div className='d-flex navigationLink justify-content-between align-items-center bg-00'>
          <div className='d-flex justify-content-between align-items-center links bg-f5'>
          ...
          <div className='d-flex justify-content-between align-items-center switchmode bg-d9'>
