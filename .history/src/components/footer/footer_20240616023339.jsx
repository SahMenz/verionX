...
function Footer() {
  return (
    <div className='d-flex bg-f5 flex-column flex-wrap-wrap footerGeneral gap-5' style={{borderRadius:"50px"}}>
        ...
        <div className='d-flex flex-column'>
            ...
            <div>
                <input  type='text' placeholder='Email address' style={{marginRight:"20px",borderRadius:"30px", padding:"15px 20px", boxShadow: "0px 0px 3px 3px rgba(0, 0, 0, 0.2)"}}/>
