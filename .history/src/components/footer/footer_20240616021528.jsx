...
function Footer() {
  return (
    <div className='d-flex flex-wrap flex-xl-nowrap'>
        <div className='d-flex flex-column justify-content-between' style={{width:"272px", height:"166px"}}>
            <img  src={logo}/>
            ...
            <div className='d-flex flex-column align-items-center justify-content-center' style={{width:"110px"}}>
